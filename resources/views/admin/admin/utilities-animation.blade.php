{-- Converted from admin/utilities-animation.html to Blade --}
<!-- Put this file in resources/views/admin/utilities-animation.blade.php -->
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link"  data-toggle="collapse" data-target="#collapseUtilities"
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" >Animations</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Bootstrap's default utility classes can be found on the official <a
                            >Bootstrap Documentation</a> page. The custom utilities
