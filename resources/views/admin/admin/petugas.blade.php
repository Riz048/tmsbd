{-- Converted from admin/petugas.html to Blade --}
<!-- Put this file in resources/views/admin/petugas.blade.php -->
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              <label>Nama Petugas</label>
              <input type="text" class="form-control" value="Nama Petugas">
            </div>
          ...
          <div class="form-group">
            <label>Alamat</label>
            <textarea class="form-control" rows="2">Alamat Petugas</textarea>
          </div>
