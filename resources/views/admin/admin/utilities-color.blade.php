{-- Converted from admin/utilities-color.html to Blade --}
<!-- Put this file in resources/views/admin/utilities-color.blade.php -->
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" >Colors</a>
